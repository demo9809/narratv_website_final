                      ...
                      <div className="flex gap-8 border-b border-gray-200">
                        <button 
                          ...
                          className={`pb-4 text-sm font-bold uppercase tracking-widest transition-all border-b-2 ${
                            formType === 'project' ? 'border-brand-accent text-brand-black' : 'border-transparent text-gray-400 hover:text-brand-black'
                          }`}
                        >
                          Start a Project
                        </button>
                        <button 
                          ...
                          className={`pb-4 text-sm font-bold uppercase tracking-widest transition-all border-b-2 ${
                            formType === 'general' ? 'border-brand-accent text-brand-black' : 'border-transparent text-gray-400 hover:text-brand-black'
                          }`}
                        >
                          General Inquiry
                        </button>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="group relative">
                          <input type="text" required id="name" className="peer w-full bg-transparent border-b border-gray-300 py-3 focus:border-brand-accent outline-none transition-all text-lg placeholder-transparent text-brand-black" placeholder="Name" />
                        ...
                        <div className="group relative">
                          <input type="email" required id="email" className="peer w-full bg-transparent border-b border-gray-300 py-3 focus:border-brand-accent outline-none transition-all text-lg placeholder-transparent text-brand-black" placeholder="Email" />
                      ...
                      {formType === 'project' && (
                        <>
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                             <div className="group relative">
                                <input type="tel" id="phone" className="peer w-full bg-transparent border-b border-gray-300 py-3 focus:border-brand-accent outline-none transition-all text-lg placeholder-transparent text-brand-black" placeholder="Phone / WhatsApp" />
                            ...
                            <div className="group relative">
                              <input type="text" id="company" className="peer w-full bg-transparent border-b border-gray-300 py-3 focus:border-brand-accent outline-none transition-all text-lg placeholder-transparent text-brand-black" placeholder="Company" />
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="group relative">
                              <select className="peer w-full bg-transparent border-b border-gray-300 py-3 focus:border-brand-accent outline-none transition-all text-lg appearance-none rounded-none text-brand-black">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                              {['Strategy', 'Branding', 'Ad Campaigns', 'Video', 'Marketing', 'Content'].map(s => (
                                <label key={s} className="flex items-center gap-3 p-4 border border-gray-200 rounded-sm cursor-pointer hover:border-brand-accent transition-all hover:bg-gray-50 group">
                                  <input type="checkbox" className="w-4 h-4 text-brand-accent focus:ring-brand-accent border-gray-300 rounded" />
                      ...
                      <div className="group relative">
                        <textarea rows={4} required id="message" className="peer w-full bg-transparent border-b border-gray-300 py-3 focus:border-brand-accent outline-none transition-all text-lg resize-none placeholder-transparent text-brand-black" placeholder="Message"></textarea>
